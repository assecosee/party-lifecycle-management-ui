export type IdentificationKindsEnum = 'registration-number' | 'tax-id-number' | 'personal-id-number' | 'identity-card-number' | 'passport-number' | 'driver-license-number' | 'social-security-number' | 'agricultural-holding-number' | 'internal-id-number';
